...
public class SimlyTypedLambdaCalculusApplicationExprImpl extends ASTWrapperPsiElement implements SimlyTypedLambdaCalculusApplicationExpr {

  public SimlyTypedLambdaCalculusApplicationExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SimlyTypedLambdaCalculusLambdaExpr> getLambdaExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SimlyTypedLambdaCalculusLambdaExpr.class);
  }
