...
public class SimplyTypedLambdaCalculusTypingExprOtherImpl extends ASTWrapperPsiElement implements SimplyTypedLambdaCalculusTypingExprOther {

  public SimplyTypedLambdaCalculusTypingExprOtherImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimplyTypedLambdaCalculusVisitor visitor) {
    visitor.visitTypingExprOther(this);
  }
