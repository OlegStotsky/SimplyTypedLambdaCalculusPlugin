...
public class SimplyTypedLambdaCalculusParExprImpl extends ASTWrapperPsiElement implements SimplyTypedLambdaCalculusParExpr {

  public SimplyTypedLambdaCalculusParExprImpl(@NotNull ASTNode node) {
    super(node);
  }
